    ...
    return n.prototype = {
        ...
        binHashStretch: function(n, h, i) {
            var t, r, f = this,
                ...
                o = f.strBin(n),
                a = o.length,
                e = f.binHash(f.strBin(e), e.length << 3);
            for (i = i || 1024, t = 0; t < i; t++) {
                for (e = f.binHexBin(e), r = 0; r < a; r++) e[8 + r] = o[r];
                e = f.binHash(e, g)
            }
            return e
        },
...
function EncryptPassword(PlainPassword,Salt){
    return [MD5Ex.hash(MD5Ex.hashStretch(PlainPassword,Salt[0],128)+Salt[1]),MD5Ex.hashStretch(PlainPassword,Salt[2],128),Salt[1]];
}
